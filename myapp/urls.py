...
urlpatterns = [
    ...
    path('verfy_it',views.verify_it),
    path("analysis", views.winPrediction, name='analysis'),
    path("features/scorePrediction", views.scorePrediction, name='score_rediction'),
    path("features/winPrediction", views.winPrediction, name='win_prediction'),
